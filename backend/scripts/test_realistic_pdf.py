#!/usr/bin/env python3
"""Test PDF upload and extraction with realistic content"""
...
# Create a more realistic PDF with sufficient text content
realistic_pdf_content = b"""%PDF-1.4
1 0 obj
<<
/Type /Catalog
/Pages 2 0 R
...
0 -14 Td
(- Residential requirement: Indian citizen) Tj
0 -14 Td
...
files = {
    "file": ("dental_scheme.pdf", realistic_pdf_content, "application/pdf")
}
...
print(f"   Eligibility: {extracted.get('eligibility_criteria', 'N/A')[:200]}...")
print(f"   About: {extracted.get('about_scheme', 'N/A')[:200]}...")
